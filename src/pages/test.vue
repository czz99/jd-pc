    ...
    <i-dialog
      ...
      <el-form :model="dialogFormData" ref="form" :rules="formRules" label-width="100px">
        <el-row>
          ...
          <el-col :span='12'>
            <el-form-item label="成本价" prop="costcostPrice">
              <el-input v-model="dialogFormData.costcostPrice" oninput = "if(isNaN(value)) { value = null } if(value.indexOf('.')>0){value=value.slice(0,value.indexOf('.')+3)}"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='12'>
            <el-form-item label="在售价" prop="sellcostPrice">
              <el-input v-model="dialogFormData.sellcostPrice" oninput = "if(isNaN(value)) { value = null } if(value.indexOf('.')>0){value=value.slice(0,value.indexOf('.')+3)}"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span='12'>
            <el-form-item label="作者" prop="goodsAuthor">
  ...
  data () {
    return {
        ...
        },
        {
          ...
          func: () => {
            ...
            req('getGoodsData', {goodsCode: this.tableSelectRows[0].goodsCode}).then(data => {
              ...
              this.dialogFormData.costcostPrice = Number(data.data.costcostPrice)
              this.dialogFormData.sellcostPrice = Number(data.data.sellcostPrice)
      ...
      columnList: [
        ...
        {label: '成本价', prop: 'costcostPrice'},
        {label: '在售价', prop: 'sellcostPrice'},
        ...
        {label: '商家名称', prop: 'outsideName', width: 100},
        {label: '商品库存', prop: 'inventory'},
        {label: '书号', prop: 'isbn'},
        {label: '作者', prop: 'goodsAuthor', width: 100},
        {label: '出版社', prop: 'goodsPress', width: 100}
      ],
      tableData: [],
      formRules: {
        goodsName: [
        ...
        if (valid) {
          if (this.dialogType === 'add') {
            req('addGoodsData', {
              ...
              costcostPrice: this.dialogFormData.costcostPrice,
              sellcostPrice: this.dialogFormData.sellcostPrice,
